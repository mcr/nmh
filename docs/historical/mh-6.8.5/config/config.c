...
#if	defined(__STDC__)
#define	binpath(file) "/opt/mh-6.8.5/bin/"#file
#define	etcpath(file) "/opt/mh-6.8.5/lib/"#file
#else
#define binpath(file) "/opt/mh-6.8.5/bin/file"
#define etcpath(file) "/opt/mh-6.8.5/lib/file"
#endif
...
char *options[] = {"ATTVIBUG", "DBMPWD", "DUMB", "FCNTL", "FOLDPROT='\"0711\"'", "MHE", "MHRC", "MIME", "MORE='\"/usr/bin/more\"'", "MSGID", "MSGPROT='\"0600\"'", "RENAME", "RPATHS", "SENDMTS", "SHADOW", "SMTP", "SOCKETS", "SPRINTFTYPE=int", "SVR4", "SYS5", "SYS5DIR", "TYPESIG=void", "VSPRINTF", NULL};
...
char   *mhlibdir = "/opt/mh-6.8.5/lib";	/* NB: this will change */

...
static char *mtstailor = "/opt/mh-6.8.5/lib/mtstailor";
...
#ifdef	MF
char   *umincproc = "/opt/mh-6.8.5/lib/uminc";
#else /* MF */
char   *umincproc = NULL;
#endif /* MF */
...
char   *Okhosts = "/opt/mh-6.8.5/lib/Rmail.OkHosts";
char   *Okdests = "/opt/mh-6.8.5/lib/Rmail.OkDests";
#endif /* MHMTS */
...
#ifdef	SENDMTS
char   *hostable = "/opt/mh-6.8.5/lib/hosts";
...
char    *popbbhost = "";
char    *popbbuser = "";
char    *popbblist = "/opt/mh-6.8.5/lib/hosts.popbb";
#endif /* BPOP */


/* MailDelivery */

char   *maildelivery = "/opt/mh-6.8.5/lib/maildelivery";
...
/* customize the MTS settings for MH by reading /opt/mh-6.8.5/lib/mtstailor */
